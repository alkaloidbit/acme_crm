		...
		<table id="example1" class="table table-bordered table-striped">
			...
			<% for (int i = 0; i < taille; i++) {%>
				<tr>
					...
					<td>
						<a class="btn btn-success me-2" href="/MSPR/Utilisateur?action=detail&valeur=<%=i%>">
							<i class="fas fa-search"></i>
						</a>
						<a class="btn btn-info me-2" href="#">
							<i class="fas fa-pen"></i>
						</a>
						<a class="btn btn-danger btn-delete" href="/MSPR/Utilisateur?action=suppression&valeur=<%=i%>">
